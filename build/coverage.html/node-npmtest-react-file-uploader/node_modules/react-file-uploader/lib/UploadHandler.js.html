...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-file-uploader/node_modules/react-file-uploader/lib/UploadHandler.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-file-uploader/node_modules/react-file-uploader/lib/UploadHandler.js</span></h1>
    <h2>
        
        Statements: <span class="metric">58.21% <small>(39 / 67)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">50% <small>(21 / 42)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-file-uploader/node_modules/react-file-uploader/lib/</a> &#187; UploadHandler.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function UploadHandler() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, UploadHandler);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, Object.getPrototypeOf(UploadHandler).apply(this, arguments));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var file = _props.file;</span>
<span class="cstat-no" title="statement not covered" >      var upload = _props.upload;</span>
<span class="cstat-no" title="statement not covered" >      var autoStart = _props.autoStart;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (file.status === _status2.default.PENDING &amp;&amp; autoStart) {</span>
<span class="cstat-no" title="statement not covered" >        debug('autoStart in on, calling upload()');</span>
<span class="cstat-no" title="statement not covered" >        upload(file);</span>
      }
    }
  }, {
    key: 'getStatusString',
    value: <span class="fstat-no" title="function not covered" >function getStatusString(status) {</span>
...
&nbsp;
        case 1:
<span class="cstat-no" title="statement not covered" >          return 'uploading';</span>
&nbsp;
        case 2:
<span class="cstat-no" title="statement not covered" >          return 'uploaded';</span>
&nbsp;
        default:
...
<span class="cstat-no" title="statement not covered" >      var key = _props2.key;</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(component, { key: key, className: (0, _classnames2.default)(customClass), style: style }, this.props.children);</span>
    }
  }]);
&nbsp;
